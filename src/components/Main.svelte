...
<main  class="flex flex-col flex-1 p-4">
    <section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
        <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi I'm <span class="poppins text-violet-400">John</span> Velie <br />Full Stack 
            ...
            <div class="relative shadow-2x1 grid place-items-center">
                <img src="images/BLANK CHARACTER 1.png" alt="Character profile" class="object-cover z-[2] max-h-[70vh]"/>
            </div>
    </section>
    ...
    <section id="about" class="py-20 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative">
        ...
        <div class="flex flex-col overflow-x-auto gap-10 mx-auto w-full max-w-fit">
            <table class="bg-white text-slate-700 rounded text-center overflow-x-scroll">
